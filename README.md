...
- Make changes to the source code if necessary to build successfully. For Ubuntu 20.04, you will need to change CMakeList from C++11 to C++14. I have incorporated the changes in [this fork](https://github.com/thien94/ORB_SLAM3).
- Build:
...
**modify the path for your orb3-slam**

```
set(ORB_SLAM3_DIR /home/robot/my_code/slam/ORB_SLAM3 )
